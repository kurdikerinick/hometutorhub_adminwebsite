...
import { storage, db } from '../../firebase/firebase'; // Ensure you have this file set up
...
const StudentRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userCredential.user) {
        ...
        await uploadFile(formData.addressproof, userCredential.user.uid);
  
        // Save form data to database
        await saveFormData(userCredential.user.uid);
  ...
  const uploadFile = async (file, userId) => {
    ...
    try {
      ...
      alert('File upload failed. Please check your permissions.');
    }
  };
