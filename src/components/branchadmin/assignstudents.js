...
const Assign = () => {
  ...
  const filteredTutors = tutors.filter(tutor => {
    const category = tutor.ccategory || '';
    return typeof category === 'string' && category.toLowerCase().includes(searchQuery.toLowerCase());
  });
  
  const filteredStudents = students.filter(student => {
    const studentClass = student.class || '';
    return typeof studentClass === 'string' && studentClass.toLowerCase().includes(searchQuery.toLowerCase());
  });
